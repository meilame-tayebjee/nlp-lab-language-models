...
class Head(nn.Module):
    ...
    def __init__(self, head_size):
        ...
        self.C = 32
        self.key = nn.Linear(self.C, head_size)
        self.query = nn.Linear(self.C, head_size)
        self.value = nn.Linear(self.C, head_size) 
    ...
    def forward(self, x):
        ...
        tril = torch.tril(torch.ones(T,T)).to(weights.device)
